    ...
    <div className="min-h-screen">
      ...
      <section className="bg-yellow-500 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl">Terms and conditions for using the ANSA Brasil website</p>
        </div>
      </section>
      ...
      <div className="container-custom py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <p>
            ...
            <strong>Phone:</strong> (703) 785-5159<br />
            <strong>Address:</strong> 3586 University Dr., Fairfax, Virginia 22030, USA
          </p>
