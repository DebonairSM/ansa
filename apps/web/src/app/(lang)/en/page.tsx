...
export const metadata: Metadata = {
  ...
  alternates: localeAlternates('en', { pt: '/pt', en: '/en' }),
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ whiteSpace: 'nowrap' }}>Secure via PayPal</span>
          </span>
          <span 
            className="inline-flex items-center gap-1.5"
            style={{
          ...
          >
            ...
            <span style={{ whiteSpace: 'nowrap' }}>43 years</span>
          </span>
          <span 
            className="inline-flex items-center gap-1.5"
            style={{
          ...
          >
            ...
            <span style={{ whiteSpace: 'nowrap' }}>100% volunteer</span>
          </span>
          <span 
            className="inline-flex items-center gap-1.5"
            style={{
          ...
          >
            ...
            <span style={{ whiteSpace: 'nowrap' }}>24 projects</span>
          </span>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              ...
              <p className="text-lg text-gray-800 font-semibold">Projects Supported</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              <p className="text-5xl font-bold mb-2 text-gray-900">10+</p>
              <p className="text-lg text-gray-800 font-semibold">States Reached</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              <p className="text-5xl font-bold mb-2 text-gray-900">43+</p>
              <p className="text-lg text-gray-800 font-semibold">Years of Mission</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              <p className="text-5xl font-bold mb-2 text-gray-900">100%</p>
              <p className="text-lg text-gray-800 font-semibold">Volunteer-Run</p>
            </div>
          </div>
        </div>
      </section>
