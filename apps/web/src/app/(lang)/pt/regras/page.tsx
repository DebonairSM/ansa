export default function RegrasPt() {
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="bg-yellow-500 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-6">Regras de Uso</h1>
          <p className="text-2xl">Termos e condições para uso do site ANSA Brasil</p>
        </div>
      </section>
      ...
      <div className="container-custom py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <p>
            As informações fornecidas neste site são para fins gerais. Embora nos esforcemos para 
            manter as informações atualizadas e corretas, não fazemos representações ou garantias 
            de qualquer tipo sobre a completude ou precisão das informações.
          </p>
          ...
          <h2>9. Contato</h2>
          <p>
            Se você tiver dúvidas sobre estas regras de uso, entre em contato conosco através de:
          </p>
          <p>
            <strong>Email:</strong> associacaonsraa@gmail.com<br />
            <strong>Telefone:</strong> (703) 785-5159<br />
            <strong>Endereço:</strong> 3586 University Dr., Fairfax, Virginia 22030, EUA
          </p>
